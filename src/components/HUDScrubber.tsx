...
export const HUDScrubber: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-30 hidden lg:flex items-center gap-3 px-3.5 py-2 rounded-xl bg-zinc-950/90 border border-white/10 text-[11px] font-mono-code backdrop-blur-md shadow-2xl text-zinc-300 pointer-events-none">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-amber-400 font-bold w-10">{(scrollProgress * 100).toFixed(1)}%</span>
      </div>
