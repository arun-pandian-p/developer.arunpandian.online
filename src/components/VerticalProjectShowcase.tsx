...
const DEFAULT_SHOWCASE_ITEMS: VerticalShowcaseItem[] = [
  {
    ...
    caption: 'Live Multi-Workspace Restaurant Canvas & Stripe Billing',
  ...
  {
    id: 'showcase-2',
    title: 'Autonomous AI Agent Reasoning & RAG Assistant',
    category: 'Autonomous AI',
    caption: 'LangChain Vector Retrieval, Tool Execution & Claude 3.7',
  ...
  },
  {
    ...
    caption: 'Webhook Triggers, Stripe Sync, CRM & AI Pipelines',
  ...
  },
  {
    ...
    caption: 'High-Concurrency PostgreSQL, Docker K8s & Telemetry',
  ...
  {
    id: 'showcase-6',
    title: 'Executive Client Proof & Recommendation Letter',
    category: 'Client Verification',
    caption: 'Signed Official Appreciation Document & MSME Seal',
