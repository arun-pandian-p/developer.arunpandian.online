  ...
  return (
    <section className="relative min-h-screen pt-28 pb-20 px-6 sm:px-12 max-w-7xl mx-auto flex flex-col justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-gradient-to-tr from-[#fda228]/25 via-amber-500/15 to-transparent rounded-full blur-[140px]"></div>
        <div className="absolute inset-0 anime-grid-bg opacity-30"></div>
      </div>

      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
        
        {/* Left Column: Perfect 3-Line Vertical Display Stack (FOR / SAAS / & AI) */}
        <div className="lg:col-span-5 space-y-4 uppercase font-syne select-none">
          <div className="text-xs font-mono-code tracking-widest text-amber-400 font-bold flex items-center gap-2">
            <span className="w-2.5 h-2.5 rounded-full bg-amber-400 animate-ping"></span>
            ARUN PANDIAN STUDIO
          </div>

          <div className="space-y-0.5">
            <div className="text-[4rem] sm:text-[6rem] lg:text-[5rem] xl:text-[6.2rem] font-black leading-[0.85] tracking-tight text-white">
              FOR
            </div>
            <div className="text-[4rem] sm:text-[6rem] lg:text-[5rem] xl:text-[6.2rem] font-black leading-[0.85] tracking-tight text-stroke-2 hover:text-white transition-all">
              SAAS
            </div>
            <div className="text-[4rem] sm:text-[6rem] lg:text-[5rem] xl:text-[6.2rem] font-black leading-[0.85] tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-amber-300 to-amber-500">
              & AI
            </div>
          </div>
        ...
        <div className="lg:col-span-4 relative flex justify-center py-2 lg:py-0">
          <div className="relative w-full max-w-xs sm:max-w-sm xl:max-w-md aspect-[4/5] rounded-3xl overflow-hidden border-2 border-amber-400/40 shadow-[0_0_50px_rgba(253,162,40,0.25)] group neumorphic-card">
        ...
        <div className="lg:col-span-3 space-y-6 flex flex-col justify-between">
          ...
          <div className="space-y-5">
            ...
            {/* Minimalist Bio Copy (Typo Fixed: web platforms) */}
          ...
          <div className="space-y-3 pt-3 border-t border-zinc-800">
            <button
              ...
              className="w-full py-3.5 rounded-2xl bg-[#fda228] hover:bg-amber-400 text-black font-bold text-xs font-mono-code uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-lg shadow-amber-500/20"
            >
              <Sparkles size={16} />
            ...
            <button
              ...
              className="w-full py-3 rounded-2xl bg-emerald-950/80 hover:bg-emerald-900 border border-emerald-500/30 text-emerald-300 font-semibold text-xs font-mono-code flex items-center justify-center gap-2 transition-all"
            >
