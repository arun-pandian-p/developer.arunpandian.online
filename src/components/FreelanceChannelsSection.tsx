...
export const FreelanceChannelsSection: React.FC = () => {
  return (
    <section id="freelance" className="py-28 lg:py-36 px-6 max-w-7xl mx-auto space-y-12">
      ...
      {/* 3 Double-Bezel Platform Cards */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {FREELANCE_PLATFORMS.map((platform, idx) => (
          <div key={idx} className="p-2 rounded-[2.5rem] bg-white/5 ring-1 ring-white/10 hover:ring-emerald-500/40 transition-all duration-500 shadow-2xl group">
            <div className="p-8 rounded-[calc(2.5rem-0.5rem)] bg-zinc-950 shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)] space-y-6 flex flex-col justify-between h-full">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2.5 pt-2">
                  <div className="text-[10px] font-mono-code text-zinc-500 uppercase font-semibold">Platform Highlights</div>
              ...
              <a
                ...
                className="group/btn flex items-center justify-between pl-6 pr-2 py-2 rounded-full bg-zinc-900 hover:bg-zinc-800 border border-white/10 text-white font-bold text-xs font-mono-code transition-all"
              >
                <span>View {platform.name}</span>
                <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center group-hover/btn:scale-110 transition-transform">
