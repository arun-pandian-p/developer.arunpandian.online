...
export const SUPABASE_URL = env.VITE_SUPABASE_URL || 'https://zyxwdvhbcoovfrtkczlc.supabase.co';
export const SUPABASE_ANON_KEY = env.VITE_SUPABASE_ANON_KEY || 'sb_publishable_3mc99Lfcb0v_FIt7Wq8WzA_cnDl5eXh';
